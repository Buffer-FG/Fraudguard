    ...
    if (args is Map<String, dynamic>) {
      setState(() {
        _userData = {
          ...
          // Add these fallback values if not in args
          "riskFactors": args['riskFactors'] ?? _mockUserData['riskFactors'],
          "timelineEvents":
              args['timelineEvents'] ?? _mockUserData['timelineEvents'],
        };
        _isLoading = false;
      });
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("No user data passed")),
      );
